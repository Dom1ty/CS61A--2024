...
class Account:
    ...
    def deposit(self, amount):
        ...
        after = self.balance
        tran_id = len(self.transactions)
        transaction = Transaction(tran_id,before,after)
...
Use Ok to test your code:"""
    ...
    if amount == smallest:
        ...
        returned_value = make_change(amount-smallest,rest)
        if type(returned_value) == list:
            return [smallest] + returned_value
        else:
